...
-- A pre-2025 addons\libs\imgui.lua misnumbers the style enums. DisabledAlpha is the tell: every
-- current libs file has it, no stale one does. Styling is then skipped and the names below are
-- filled with the current engine's values.
