...
-- Held in memory only, never written to disk. A reload puts everything back.
local config = T{
...
ashita.events.register('load', 'load_cb', function ()
    if (compat.StaleLibs) then
        print(chat.header(addon.name):append(chat.error('Your Ashita addons\\libs folder is out of date. Styling is off until you replace it.')));
    end
end);
