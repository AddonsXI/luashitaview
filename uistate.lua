...
local S = {
    ...
    rulesCache = nil,
    --[[
    * Bumped on window open; every collapsible section closes itself once per value.
    * An epoch rather than a flag: a section only closes itself on a frame it draws,
    * and one nested under a closed parent may not draw for a long time, so a flag
    * cleared at frame end would miss it.
    --]]
    openEpoch = 0,
    wasOpen = false,
    handlerEpoch = {},
