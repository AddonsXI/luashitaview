...
--]]
--[[
* The body of a handler that holds nothing but EquipSet lines, as a span to replace plus
* the sets it already equips.
*
...
*
* Anything else in the body, a condition, a variable, a call we do not recognize, returns
* nil. Absorbing code we did not write is not something a button should do.
--]]
M.SimpleHandlerBody = function(text, handlerName)
    ...
    return { s = bodyStart, e = at - 1, equips = equips };
end
